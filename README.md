...
4. **diarize** – Speaker segmentation with adaptive VAD tuning, VAD flip diagnostics for stability checks, and silhouette/dominance-based single-speaker collapse
