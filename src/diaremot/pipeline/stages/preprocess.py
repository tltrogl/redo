...
def run_background_sed(
    ...
    try:
        ...
        if tagger is not None and state.y.size > 0 and state.sr:
            ...
            # Extract and normalize ranking metadata
    ...
    # Final normalization of ranking fields
    ...
    if not isinstance(ranking_list, list):
        sed_info["tagger_ranking"] = []
    sed_info.setdefault("tagger_ranking_size", len(sed_info.get("tagger_ranking") or []))
