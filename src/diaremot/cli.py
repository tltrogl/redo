...
def resume(
    ...
    resume_overrides: dict[str, Any] = {
        ...
        "cpu_diarizer": cpu_diarizer,
        "local_first": not remote_first,
        # diar_use_sed_timeline is intentionally set by the CLI parameter and
        # may also be provided by _common_overrides elsewhere; keep only one
        # canonical mapping in this command to avoid duplication.
    }
